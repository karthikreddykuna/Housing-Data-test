...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/Housing-Data-test/master/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: -54712.41048112005
exported_pipeline = DecisionTreeRegressor(max_depth=5, min_samples_leaf=17, min_samples_split=18)
...
encoder_location = 'https://github.com/karthikreddykuna/Housing-Data-test/blob/master/encoder.pkl?raw=true'
